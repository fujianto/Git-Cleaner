...
namespace xDialog
{
    class MsgBox : Form
    {
        ...
        private MsgBox()
        {
            ...
            this.BackColor = Color.FromArgb(255,255,255);          //color Main background Messagebox
            this.StartPosition = FormStartPosition.CenterScreen;
            this.Padding = new System.Windows.Forms.Padding(3);
            this.Width = 400;

            _lblTitle = new Label();
            _lblTitle.ForeColor = Color.Black;                      //Color Messagebox Title
            _lblTitle.Font = new System.Drawing.Font("Segoe UI", 18);
            _lblTitle.Dock = DockStyle.Top;
            _lblTitle.Height = 50;

            _lblMessage = new Label();
            _lblMessage.ForeColor = Color.Black;                     //Color Messagebox text
            ...
            _plFooter.BackColor = Color.FromArgb(0, 174, 219);   //color secondary background messagebox
            _plFooter.Height = 80;
        ...
        private static void InitButtons(Buttons buttons)
        {
            ...
            {
                btn.ForeColor = Color.FromArgb(250, 250, 250); //color button text
                btn.Font = new System.Drawing.Font("Segoe UI", 8);
                btn.Padding = new Padding(3);
                btn.FlatStyle = FlatStyle.Flat;
                btn.Height = 30;
                btn.FlatAppearance.BorderColor = Color.FromArgb(95, 213, 243); //color border button
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Pen pen = new Pen(Color.FromArgb(238, 238, 238)); //color border messagebox
